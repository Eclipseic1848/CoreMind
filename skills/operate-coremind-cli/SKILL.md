...
description: "Provide a beginner end-to-end path through create, run, chat, check, eval, doctor, and templates, with run --resume for unfinished runs that have a safe recovery boundary. Use when creating, changing, reviewing, or diagnosing the cli and tui capability in a CoreMind project."
---
...
6. Run the tests listed in [module.yaml](../../docs/modules/operate-coremind-cli/module.yaml) and `npm run check:modules`.
