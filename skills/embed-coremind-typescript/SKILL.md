...
description: "Embed runtime, tools, sessions, evaluation, and events in Node applications through the single coremind-ai facade. Use when creating, changing, reviewing, or diagnosing the typescript sdk capability in a CoreMind project."
---
...
6. Run the tests listed in [module.yaml](../../docs/modules/embed-coremind-typescript/module.yaml) and `npm run check:modules`.
