...
description: "Inherit the provider catalog from the locked runtime dependency while keeping availability separate from real certification. Use when creating, changing, reviewing, or diagnosing the providers and models capability in a CoreMind project."
---

# Providers and Models

1. Read [the module contract](../../docs/modules/manage-providers/README.en.md) and the language-matched guide only when implementation details are needed.
2. Identify the business owner, accepted inputs and outputs, failure conditions, permission mode, and quality profile.
3. Follow [the SOP](../../docs/modules/manage-providers/SOP.en.md) in order. Do not invent unresolved business rules or broaden the requested architecture.
...
7. Keep incomplete or older evidence configurable and unverified; regenerate the matrix and inspect certification gaps.
8. Run the tests listed in [module.yaml](../../docs/modules/manage-providers/module.yaml) and `npm run check:modules`.
