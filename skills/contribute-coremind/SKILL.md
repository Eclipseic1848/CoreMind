...
9. For release-facing changes, require Release Please's draft PR, synchronized npm/Python versions, P01-P19 evidence anchors, both real TTY files, a current live-provider recheck, and one clean-tag artifact bundle.
