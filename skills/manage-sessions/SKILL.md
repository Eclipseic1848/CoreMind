...
6. Inject compaction failure, require `context_compaction_failed`, preserve original messages, and verify the six mandatory summary sections.
7. Run the tests listed in [module.yaml](../../docs/modules/manage-sessions/module.yaml) and `npm run check:modules`.
