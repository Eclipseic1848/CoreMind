---
name: project-agent
description: "Develop and verify the Bounded Research Agent CoreMind golden example. Use when adapting this example, its business rules, tools, workflow, evaluation, or failure cases."
---
