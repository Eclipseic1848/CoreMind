...
The current target is 1.0.1. Neither the historical 0.7.0 network exception nor the 0.7.1 offline promotion applies; this version requires every strict check.
