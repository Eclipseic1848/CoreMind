...
- [Sessions and Context](manage-sessions/README.en.md)
- [Permissions and Security](enforce-agent-permissions/README.en.md)
- [Checkpoints, Diffs, and Restore](manage-checkpoints/README.en.md)
- [Trace, RunState, and Debugging](inspect-agent-traces/README.en.md)
- [Testing, Evaluation, and Quality Gates](evaluate-agents/README.en.md)
- [CLI and TUI](operate-coremind-cli/README.en.md)
- [TypeScript SDK](embed-coremind-typescript/README.en.md)
- [Python SDK and Tool Bridge](embed-coremind-python/README.en.md)
- [Templates and Project Guidance](scaffold-coremind-projects/README.en.md)
- [Source and Community Contribution](contribute-coremind/README.en.md)
