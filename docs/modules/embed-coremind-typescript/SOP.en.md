...
5. For explicit Loops, verify state order, pause-resume, exhaustion, timeout, abort, and effect receipts; host verification must also check candidate identity, durable replies, and final outcome.
