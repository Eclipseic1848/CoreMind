...
The stability gate runs the complete suite three consecutive times and stops at the first failure. The `0.2.0-rc.1` candidate coverage floor is 72.54% lines, 70.51% statements, 79.82% functions, and 62.66% branches. The gate rejects every decrease and reports the remaining gaps to the 80% repository and 90% critical-branch long-term targets without claiming they are already met.
