...
`0.2.0-rc.1` 保持为不可变参考基线；GitHub Release、npm 与 PyPI 决定各渠道实际可安装的最新版本。当前 `0.3.0-rc.1` 源码线包含：
...
- Windows/Linux 自动化与双平台真实 TTY 相结合的验收流程，以及 GitHub、npm、PyPI 和双语文档站同步发布流程。
...
当前稳定线聚焦 `0.3.0-rc.1` 已交付能力的可靠性和可用性：
