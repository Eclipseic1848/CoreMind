...
This guide is for users migrating from `0.2.0-rc.1` to or evaluating `0.3.0`. The source is currently a stable candidate; check GitHub Releases, npm, and PyPI before installation to confirm that `0.3.0` is available through the selected channel.
