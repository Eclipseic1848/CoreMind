...
This guide is for users migrating from or evaluating `0.3.0-rc.1` against `0.2.0-rc.1`. Check GitHub Releases, npm, and PyPI before installation to confirm that the target version is available through the selected channel.
