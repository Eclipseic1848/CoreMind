...
> 表格基于 2026-08-26 的运行时静态目录和人工证据台账生成，当前对应稳定版 `0.7.0`。不应手工修改表格。
...
|---|---|---|---:|---|---|
| `alibaba-model-studio` | `qwen-plus` | `0.3.2` | 1 | 可配置，0.7.0 未认证（保留旧版证据） | [证据](https://github.com/Eclipseic1848/CoreMind/blob/main/docs/providers/evidence/alibaba-model-studio-0.3.2-2026-08-26.json) |
