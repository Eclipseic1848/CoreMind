...
|---|---|---|---:|---|---|
| `alibaba-model-studio` | `qwen-plus` | `0.3.0-rc.1` | 1 | 已认证 | [证据](https://github.com/Eclipseic1848/CoreMind/blob/main/docs/providers/evidence/alibaba-model-studio-2026-08-12.json) |
