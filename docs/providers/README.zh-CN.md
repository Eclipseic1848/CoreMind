...
> 生成日期：2026-08-21。本页由运行时静态目录和人工证据台账生成，不应手工改表格。
...
|---|---|---|---:|---|---|
| `alibaba-model-studio` | `qwen-plus` | `0.3.1` | 1 | 已认证 | [证据](https://github.com/Eclipseic1848/CoreMind/blob/main/docs/providers/evidence/alibaba-model-studio-0.3.1-2026-08-21.json) |
