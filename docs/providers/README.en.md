...
> This table was generated from the 2026-08-26 static runtime catalog and human-maintained evidence ledger and now corresponds to stable `0.8.0`. Do not edit the table manually.
...
|---|---|---|---:|---|---|
| `alibaba-model-studio` | `qwen-plus` | `0.3.2` | 1 | Configurable, 0.8.0 unverified (older evidence retained) | [Evidence](https://github.com/Eclipseic1848/CoreMind/blob/main/docs/providers/evidence/alibaba-model-studio-0.3.2-2026-08-26.json) |
