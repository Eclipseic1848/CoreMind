...
> Generated on 2026-08-13 from the static runtime catalog and the human-maintained evidence ledger. Do not edit the table manually.
...
|---|---|---|---:|---|---|
| `alibaba-model-studio` | `qwen-plus` | `0.3.0` | 1 | Certified | [Evidence](https://github.com/Eclipseic1848/CoreMind/blob/main/docs/providers/evidence/alibaba-model-studio-0.3.0-2026-08-13.json) |
