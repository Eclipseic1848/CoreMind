...
当前源码候选统一声明稳定版 `0.7.0`，包含 Protocol v2、统一安全与错误合同，以及贯通四个正式入口的 Child Run 产品链路。已合入实现通过 Node 22 双平台工程 CI；候选包双平台验收、真实 Provider 父子 Agent 认证、Tag、Registry 与 GitHub Release 尚未完成，因此公开稳定版仍是 `0.3.1`。
