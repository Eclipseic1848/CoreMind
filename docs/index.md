...
CoreMind 当前代码版本为 `0.3.0-rc.1`。是否已经公开可安装，请以 Release 与 Registry 为准；源码始终可用于评审和共同开发。请阅读[公开路线图](/roadmap.zh-CN)、[安全边界](/guide/04-quality)和[供应商认证矩阵](/providers/README.zh-CN)。
