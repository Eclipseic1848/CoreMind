...
CoreMind 当前仓库源码候选为尚未发布的 `0.3.0-rc.1`，最新公开版本仍是 `0.2.0-rc.1`。源码候选适合评审和共同开发；公开安装请以 Release 与 Registry 为准。请阅读[公开路线图](/roadmap.zh-CN)、[安全边界](/guide/04-quality)和[供应商认证矩阵](/providers/README.zh-CN)。
