...
`0.3.2` 候选已合入仓库并完成 Node 22 双平台 CI、真实 Provider 七项认证与 RC 验收；Tag、Registry 与 GitHub Release 尚未创建，因此公开稳定版仍是 `0.3.1`。当前 `main` 另含未发布的 `0.4.x` Protocol v2、AgentDriver 与 ExecutionEnvironment 源码。
