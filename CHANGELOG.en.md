...
- This entry describes an unpublished stable candidate. Complete automated gates, candidate provider revalidation, exact `main` identity, final Windows maintainer acceptance, and Release Readiness remain separate planned stages.
