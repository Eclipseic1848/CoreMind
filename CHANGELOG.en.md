...
## 0.7.0 — 2026-09-02 (unpublished stable candidate)
...
- The root version, eight npm packages, exact internal dependencies, Python SDK, bundled Worker, module contracts, candidate documentation, and Release Please metadata now agree on stable `0.7.0`. Source development and CI pin npm `11.5.1` so a retired legacy audit endpoint cannot reject a valid workspace tree. A no-tag candidate entry builds npm tarballs, the Python wheel, and a source ZIP from one clean commit with size and SHA-256 records; the tag, GitHub Release, npm, PyPI, and clean public reinstall remain independent Release Closure gates.
